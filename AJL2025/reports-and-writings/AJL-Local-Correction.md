...
### Building a Corrective Function

As the EPA recommends, the mean relative humidity may be held constant such that the multilinear corrective function instead becomes a linear regression; that is - 
If PAcf_1  <= 343:
